...
class MainActivity : AppCompatActivity(),
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
     ...
     fun activityMain(v: View) {
         ...
         Navigation.findNavController(findViewById(R.id.fragment)).navigate(R.id.home_fragment)
...
/**
         val action = main_fragmentDirections.ActionMainFragmentToHomeFragment();
