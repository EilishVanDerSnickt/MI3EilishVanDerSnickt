    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_instellingen -> {
                Navigation.findNavController(findViewById(R.id.fragment)).navigate(R.id.settings_fragment)
            }
            R.id.nav_afmelden -> {
                setContentView(R.layout.login)
            }
     ...
     fun activityMain(v: View) {
         ...
         */
         ...
         val action = main_fragmentDirections.ActionMainFragmentToBoodschappenlijstjeFragment();
